...
ðŸ‘‰ [TinyOpt](/download/) comes with built-in multi-key management. If you're designing a similar resource pool, the KeyManager in the source code is a good reference implementation.
