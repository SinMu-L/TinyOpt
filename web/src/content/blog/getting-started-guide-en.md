...
description: A complete beginner's guide to TinyOpt Compressor. Download, get your API key, and run your first batch compression — all in under 10 minutes.
tags: [beginners-guide, getting-started, tutorial]
---

The first time I opened TinyOpt, I had 150 event photos that needed to go into the company CMS. Each file was about 5MB. The CMS limit: 2MB per file. I tried renaming extensions, using Paint to resize — nothing worked well.

A friend recommended TinyOpt. Download, API key setup, drag in images, click compress. From installation to completing all 150 images: **under 10 minutes**. Output files averaged 400KB. No visible quality loss.
...
TinyOpt uses the TinyPNG API for compression. You'll need a free API key:
...
TinyOpt comes with 2 shared keys pre-configured. But shared keys have limited capacity — registering your own key is recommended for reliability.
...
Yes. TinyOpt is portable — copy the folder to another Windows PC and it works (you'll need to configure API keys).
...
From download to first compression: under 10 minutes. TinyOpt is designed to be intuitive — no manual needed, no complex setup.
