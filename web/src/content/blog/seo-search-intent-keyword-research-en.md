...
|------------|-------------------|-----------------|-----------------|
| Informational | Learn something | "what is mccb" / "how does a valve work" | Blog posts, guides, FAQ |
| Commercial | Compare options | "best mccb manufacturer" / "valve vs gate valve" | Comparisons, reviews, buying guides |
...
| Scenario | Solution |
|----------|---------|
| Two articles with similar content and same intent | Merge into one, 301 redirect the other |
| Different intent but overlapping keywords | No merge needed; ensure clear differentiation |
| Older article is outdated | Update the old article, de-index the new one |
