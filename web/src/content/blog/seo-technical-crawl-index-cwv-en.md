...
|--------|-----------------|------|------|--------|
| LCP (Largest Contentful Paint) | Loading speed | ≠.5s | >4.0s | 75th percentile |
| INP (Interaction to Next Paint) | Responsiveness | ≠00ms | >500ms | 75th percentile |
| CLS (Cumulative Layout Shift) | Visual stability | ≠.1 | >0.25 | 75th percentile |
