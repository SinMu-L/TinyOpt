...
Last year I audited a B2B export site generating $20M in annual revenue. Technically it was sound â€?fast server, HTTPS enabled, mobile-friendly. Yet Google had indexed 400+ pages, and fewer than 30 keywords had rankings.
...
## 01. The Title Tag â€?Your First Impression in Search Results
...
- **Primary keyword near the front** â€?within the first 60 characters. Google typically displays 50-60 characters (approx 580-600px) before truncating
- **Every page unique** â€?no two pages should share the same Title
- **No keyword stuffing** â€?Google explicitly classifies this as a spam policy violation [^2]
- **Include brand name** â€?at the end, separated by a pipe, e.g., "MCCB 630A 3-Pole | ABC Electric"
...
We restructured Title tags for a packaging machinery client. Their product pages all used "Product â€?Brand Name" format. After switching to individual titles with "Model + Core Selling Point | Brand", click-through rate rose from 2.1% to 4.8% in 6 weeks.

## 02. Meta Description â€?The CTR Lever
...
## 03. Heading Hierarchy (H1/H2/H3) â€?Structuring Content for Search Engines
...
1. **One H1 per page â€?no exceptions**
2. **Never skip heading levels** (H1 â†?H3 is invalid)
...
â”œâ”€â”€ H2: What Is a Gate Valve?
â”?  â””â”€â”€ H3: Gate Valve vs Ball Valve
â”œâ”€â”€ H2: Key Specifications to Consider
â”?  â””â”€â”€ H3: Pressure Rating and Temperature Limits
â”œâ”€â”€ H2: Top 5 Gate Valve Manufacturers Compared
â””â”€â”€ H2: Frequently Asked Questions
```
...
E-E-A-T stands for Experience, Expertise, Authoritativeness, and Trustworthiness â€?the framework Google's quality raters use to evaluate pages [^6].
...
1. **Audit Title uniqueness** â€?Use Screaming Frog or Sitebulb to find duplicate or missing Titles
2. **Establish H1 review process** â€?No page goes live without confirming one unique H1
3. **Rewrite Meta Descriptions** â€?Every landing page gets an independent, CTA-included description
4. **Add author information** â€?Technical articles and product pages need bylines
5. **Verify factual accuracy** â€?Check technical specs, industry citations, and data freshness

On-page SEO doesn't require a massive redesign. 80% of the impact comes from 20% of the fundamentals â€?get Title, H1, and Description right, and rankings will follow.
...
[^4]: Google Search Central, "How Search Works â€?Organizing Information", https://www.google.com/search/howsearchworks/how-search-works/
