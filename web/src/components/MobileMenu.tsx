    ...
    <div ref={menuRef} class="lg:hidden">
      ...
      {open && (
        <div class="fixed inset-0 z-[60] flex">
          ...
          <div class="relative ml-auto flex w-72 max-w-[80vw] flex-col bg-white shadow-xl overflow-x-hidden pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
            ...
            <div class="border-t border-gray-100 px-3 py-3">
              ...
              >
                ...
                <span class="truncate">{langLabel}</span>
              </a>
            </div>
          </div>
        </div>
